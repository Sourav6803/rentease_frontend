// // contexts/VendorAnalyticsContext.js
...
// export const VendorAnalyticsProvider = ({ children, vendorId }) => {
...
//     try {
//       const response = await axios.get(`/api/vendor/analytics/overview`, {
...
//     try {
//       const response = await axios.get(`/api/vendor/analytics/sales-report`, {
//         params: { vendorId, period }
//       });
...
//     try {
//       const response = await axios.get(`/api/vendor/analytics/product-performance`, {
//         params: { vendorId, period, limit: 10 }
//       });
//       setProductPerformance(response.data);
//       return response.data;
//     } catch (err) {
//       message.error('Failed to fetch product performance');
//       setError(err);
//       throw err;
//     }
//   }, [vendorId, period]);
...
//     try {
//       const response = await axios.get(`/api/vendor/analytics/customer-insights`, {
//         params: { vendorId, period }
//       });
//       setCustomerInsights(response.data);
//       return response.data;
//     } catch (err) {
//       message.error('Failed to fetch customer insights');
//       setError(err);
//       throw err;
//     }
//   }, [vendorId, period]);
