...
//   { id: '1', action: 'Completed delivery', customer: 'Rajesh Gupta', time: '10:15 AM', earnings: 85, status: 'success' },
//   { id: '2', action: 'Received rating', customer: 'Meera Sharma', time: '9:30 AM', rating: 5, status: 'success' },
...
//           ? profileRes.value.data?.profile ?? null
//           : null
//       const nextStats =
//         statsRes.status === 'fulfilled' && statsRes.value.success
//           ? statsRes.value.data?.stats ?? null
//           : null
//       const nextToday =
//         todayRes.status === 'fulfilled' && todayRes.value.success
//           ? todayRes.value.data?.deliveries ?? []
//           : []
//       const nextActive =
//         activeRes.status === 'fulfilled' && activeRes.value.success
//           ? activeRes.value.data?.deliveries ?? []
//           : []
//       const nextActivity =
...
//       if (!nextProfile && !nextStats) {
//         applyFallback()
//         usedFallback = true
//       } else {
//         setProfile(nextProfile ?? FALLBACK_PROFILE)
//         setStats(nextStats ?? FALLBACK_STATS)
//         setTodayDeliveries(nextToday.length ? nextToday : FALLBACK_DELIVERIES)
//         setActiveDeliveries(nextActive)
//         setActivities(nextActivity.length ? nextActivity : FALLBACK_ACTIVITIES)
//         setIsUsingFallback(usedFallback || !nextProfile)
//       }
//     } catch {
//       applyFallback()
//     } finally {
...
//     const next = !current.availability.isOnDuty
//     try {
//       const res = await deliveryPartnerApi.updateAvailability({ isOnDuty: next })
...
//       }
//     } catch {
//       // local toggle for demo / offline
//     }
//     setProfile({
//       ...current,
//       availability: { ...current.availability, isOnDuty: next },
//     })
//   }, [profile])
