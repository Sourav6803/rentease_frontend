      ...
      return (
        <div key={cat._id}>
          ...
          <div
            ...
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLDivElement).style.backgroundColor =
                cat.isActive ? "transparent" : "#FFF8F8";
            }}
            className="group"
          >
            {/* Depth line */}
            ...
            >
              {hasKids ? (
                expanded ? (
                  <ChevronDown
                    style={{ width: 14, height: 14, color: FK_BLUE }}
                  />
                ) : (
                  <ChevronRight
                    style={{ width: 14, height: 14, color: "#888" }}
                  />
                )
              ) : (
                <span
            ...
            >
              {cat.level < 3 && (
                <ActionBtn
                  ...
                  onClick={() =>
                    router.push(
                      `/admin/categories/add?parent=${cat._id}&parentName=${encodeURIComponent(cat.name)}&level=${cat.level + 1}`,
                    )
                  }
                />
              )}
              ...
              <div style={{ position: "relative" }}>
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    setOpenMenu(isMenuOpen ? null : cat._id);
                  }}
                  style={{
                    width: 28,
                    height: 28,
                ...
                {isMenuOpen && (
                  ...
                  >
                    <MenuItem
                      ...
                      label="Edit Category"
                      onClick={() => {
                        router.push(`/admin/categories/edit/${cat._id}`);
                        setOpenMenu(null);
                      }}
                    />
                    <MenuItem
                    ...
                    <MenuItem
                      icon={
                        <Trash2
                          style={{ width: 13, height: 13, color: FK_RED }}
                        />
                      }
                      label="Delete"
                      danger
