...
const productSchema = z.object({
  ...
  pricing: z.object({
    ...
    rentalOptions: z.array(z.object({ months: z.number(), discount: z.number().min(0).max(100) })),
  }),
  inventory: z.object({
  ...
  rentalTerms: z.object({
    minRentalMonths: z.number().min(1).max(12),
    maxRentalMonths: z.number().min(1).max(36),
    deliveryAvailable: z.boolean(),
    pickupAvailable: z.boolean(),
    serviceablePincodes: z.array(z.string()),
