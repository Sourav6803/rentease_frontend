...
//       {/* Hero Header */}
//       <div className="relative overflow-hidden bg-gradient-to-r from-violet-700 via-indigo-700 to-blue-700 px-6 py-8 mb-8">
//         {/* Decorative blobs */}
...
//                 <SelectTrigger className="w-[140px] bg-white/10 border-white/30 text-white hover:bg-white/20 [&>span]:text-white">
...
//           <>
//             {/* KPI Grid */}
//             <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 mb-8 -mt-4">
//               {KPIS.map((kpi, idx) => {
...
//                   <Card
//                     key={kpi.label}
//                     className="relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 cursor-pointer group"
//                   >
//                     {/* Gradient background */}
...
//               {/* Custom Tab Bar */}
//               <div className="flex gap-2 flex-wrap p-1.5 bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 w-fit">
