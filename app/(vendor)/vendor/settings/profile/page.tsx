// // src/app/vendor/settings/profile/page.tsx
// 'use client'
...
//       setServiceableCities([...serviceableCities, newCity])
...
//       setServiceablePincodes([...serviceablePincodes, newPincode])
//       setNewPincode('')
//     }
//   }

//   const removePincode = (pincode: string) => {
//     setServiceablePincodes(serviceablePincodes.filter(p => p !== pincode))
//   }
...
//           { label: 'Total Rentals', value: profile?.performance?.metrics?.totalRentals || 0, icon: TrendingUp, color: 'text-green-500', bg: 'bg-green-50' },
//           { label: 'Total Revenue', value: `₹${((profile?.performance?.metrics?.totalRevenue || 0) / 1000).toFixed(1)}K`, icon: DollarSign, color: 'text-purple-500', bg: 'bg-purple-50' },
//           { label: 'Rating', value: profile?.performance?.rating?.average || 0, icon: Star, color: 'text-yellow-500', bg: 'bg-yellow-50' },
//         ].map((stat, idx) => {
...
//                       {city.city}, {city.state}
//                       <button type="button" onClick={() => removeCity(idx)} className="ml-1 hover:text-red-500">
//                         <X className="h-3 w-3" />
//                       </button>
//                     </Badge>
//                   ))}
...
//                     className="flex-1"
//                   />
//                   <Button type="button" onClick={addPincode} size="icon">
//                     <Plus className="h-4 w-4" />
//                   </Button>
//                 </div>
//                 <div className="flex flex-wrap gap-2">
...
//                     <Badge key={idx} variant="secondary" className="gap-1">
//                       {pincode}
//                       <button type="button" onClick={() => removePincode(pincode)} className="ml-1 hover:text-red-500">
//                         <X className="h-3 w-3" />
//                       </button>
//                     </Badge>
//                   ))}
