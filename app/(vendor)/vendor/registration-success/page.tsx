// URL: /vendor/registration-success (route group (vendor) is omitted from the path)
...
export const metadata: Metadata = {
  ...
  description:
    'Your vendor registration has been submitted successfully. Please verify your email to complete the process.',
