...
//     }
//   }, [status, currentPage, categoryFilter, searchQuery])

//   const fetchPendingProducts = async () => {
//     setIsLoading(true)
//     try {
//       const response = await axios.get(`${BASE_URL}/api/v1/products/admin/pending`, {
//         params: {
//           page: currentPage,
//           limit: 20,
...
//                   Review and approve product listings from vendors
//                 </p>
//               </div>
//             </div>
//           </div>
//           <div className="flex items-center gap-2">
//             <Button variant="outline" onClick={fetchPendingProducts} className="gap-2">
...
//                 </div>
//                 <div>
//                   <p className="text-sm font-medium text-yellow-800">Products Awaiting Review</p>
//                   <p className="text-2xl font-bold text-yellow-900">{pendingCount}</p>
//                 </div>
//               </div>
//               <Badge className="bg-yellow-200 text-yellow-800">Pending Approval</Badge>
//             </div>
//           </CardContent>
//         </Card>
...
//             const vendorOwner = product.vendor?.user?.profile?.firstName 
...
//                         <span className="font-medium">{vendorOwner}</span>
//                       </div>
//                       <div className="flex justify-between text-sm">
...
//                         <span className="font-semibold text-primary">₹{product.pricing.monthlyRent.toLocaleString()}/month</span>
//                       </div>
//                       <div className="flex justify-between text-sm">
//                         <span className="text-muted-foreground">Submitted:</span>
//                         <span>{format(new Date(product.createdAt), 'dd MMM yyyy')}</span>
//                       </div>
//                     </div>
