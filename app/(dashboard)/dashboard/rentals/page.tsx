...
// â”€â”€â”€ Design tokens (matches the Profile page system â€” light, colorful) â”€â”€â”€â”€â”€
const T = {
...
// Reusable button treatments â€” blue gradient primary, no black buttons anywhere.
...
// Status configuration â€” light chip colors (bg/text/border) + a solid hex
        ...
        <div className="p-6 pt-7">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 space-y-4 min-w-0">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className={`text-sm font-medium ${T.textPrimary}`}>
                      {formatDate(rental.rentalDetails.startDate)} â€“ {formatDate(rental.rentalDetails.endDate)}
                    </p>
              ...
              {/* Action Buttons â€” stopPropagation so they don't trigger the card's navigate-on-click */}
...
export default function RentalsPage() {
  ...
  useEffect(() => {
    if (status === 'unauthenticated') router.push('/login?callbackUrl=/dashboard/rentals')
  }, [status, router])
  ...
  return (
    <div className={`min-h-screen ${T.page} ${jakarta.variable} ${fraunces.variable} ${plexMono.variable}`} style={{ fontFamily: 'var(--font-body), system-ui, sans-serif' }}>
      {/* Ambient background â€” soft colorful blurs on light bg */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            {/* Status tabs â€” equal-width on mobile so they never overlap, same fix as Profile page */}
