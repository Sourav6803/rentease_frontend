...
// import { format, formatDistance, differenceInDays, addMonths, isAfter, isBefore } from 'date-fns'
...
//     icon: Clock,
//     description: 'Your rental request is awaiting vendor confirmation.'
//   },
//   confirmed: {
//     label: 'Confirmed',
//     color: 'text-blue-700',
...
//     icon: CheckCircle,
//     description: 'Vendor has confirmed your rental. Preparing for delivery.'
//   },
//   ready_for_delivery: {
...
//     icon: Package,
//     description: 'Product is ready and will be dispatched soon.'
//   },
//   out_for_delivery: {
...
//     icon: Home,
//     description: 'Product has been delivered to your address.'
//   },
//   active: {
//     label: 'Active',
...
//     icon: Zap,
//     description: 'Your rental is active and ongoing.'
//   },
//   extension_requested: {
...
//     icon: RotateCcw,
//     description: 'Extension request pending vendor approval.'
//   },
//   return_initiated: {
...
//     icon: RotateCcw,
//     description: 'Return request submitted. Awaiting pickup.'
//   },
//   out_for_pickup: {
...
//     icon: Truck,
//     description: 'Pickup is scheduled for your return.'
//   },
//   completed: {
//     label: 'Completed',
...
//     icon: CheckCircle,
//     description: 'Rental completed successfully. Thank you!'
//   },
//   cancelled: {
//     label: 'Cancelled',
//     color: 'text-red-700',
...
//     bg: 'bg-red-50 border-red-200',
//     icon: AlertTriangle,
//     description: 'Rental period has ended. Please initiate return.'
//   },
//   disputed: {
//     label: 'Disputed',
//     color: 'text-orange-700',
//     bg: 'bg-orange-50 border-orange-200',
//     icon: AlertCircle,
//     description: 'There is a dispute on this rental.'
//   }
// }
...
//       {/* Vertical Line */}
//       <div className="absolute left-4 top-0 bottom-0 w-px bg-gradient-to-b from-indigo-500 via-gray-200 to-transparent" />
      
//       <div className="space-y-6">
//         {sortedTimeline.map((event, index) => {
//           const config = STATUS_CONFIG[event.status] || { icon: Clock, color: 'text-gray-600', bg: 'bg-gray-100' }
...
//                     Amount: {formatCurrency(event.metadata.amount)}
//                   </p>
//                 )}
//               </div>
//             </motion.div>
...
//                 {payment.method?.replace(/_/g, ' ')} • {payment.type}
//               </p>
//             </div>
//           </div>
...
//                 TXN: {payment.paymentDetails.transactionId.slice(-8)}
//               </p>
//             )}
//           </div>
//         </div>
...
//       router.push(`/login?callbackUrl=/rentals/${rentalId}`)
//     }
...
//         `${BASE_URL}/api/v1/rentals/${rental._id}/cancel`,
//         { reason: cancelReason },
//         { headers: { Authorization: `Bearer ${session?.user?.accessToken}` } }
//       )
...
//     try {
//       const response = await axios.post(
//         `${BASE_URL}/api/v1/rentals/${rental._id}/extend`,
//         { extensionMonths },
//         { headers: { Authorization: `Bearer ${session?.user?.accessToken}` } }
//       )
...
//           returnSlot: returnSlot || '9 AM - 12 PM'
//         },
//         { headers: { Authorization: `Bearer ${session?.user?.accessToken}` } }
//       )
...
//     // try {
//     //   const response = await axios.get(
//     //     `${BASE_URL}/api/v1/rentals/${rental._id}/invoice/download`,
//     //     {
//     //       headers: { Authorization: `Bearer ${session?.user?.accessToken}` },
//     //       responseType: 'blob'
//     //     }
...
//     //   link.href = url
//     //   link.setAttribute('download', `invoice-${rental.rentalNumber}.pdf`)
...
//                     <button
//                       key={idx}
//                       className="w-16 h-16 rounded-lg overflow-hidden border-2 border-transparent hover:border-indigo-500 transition-all flex-shrink-0"
//                     >
//                       <img
//                         src={img.thumbnail}
//                         alt={`${rental.product.basicInfo.name} ${idx + 1}`}
...
//                         <p className="font-medium">{rental.product.basicInfo.brand || '—'}</p>
//                       </div>
//                       <div>
//                         <p className="text-xs text-gray-500">Monthly Rent</p>
//                         <p className="font-medium">{formatCurrency(rental.rentalDetails.monthlyRent)}</p>
//                       </div>
//                       <div>
//                         <p className="text-xs text-gray-500">Security Deposit</p>
//                         <p className="font-medium">{formatCurrency(rental.rentalDetails.securityDeposit)}</p>
//                       </div>
//                       <div>
//                         <p className="text-xs text-gray-500">Late Fee</p>
//                         <p className="font-medium">{formatCurrency(rental.product.pricing.lateFeePerDay)}/day</p>
//                       </div>
//                     </div>
//                     {rental.product.basicInfo.description && (
//                       <div>
//                         <p className="text-xs text-gray-500 mb-1">Description</p>
//                         <p className="text-sm text-gray-600">{rental.product.basicInfo.description}</p>
//                       </div>
//                     )}
...
//                         <p className="font-medium">{formatDate(rental.rentalDetails.startDate)}</p>
//                       </div>
//                       <div>
//                         <p className="text-xs text-gray-500">End Date</p>
//                         <p className="font-medium">{formatDate(rental.rentalDetails.endDate)}</p>
//                       </div>
//                       <div>
...
//                           <p className="font-medium">{formatDate(rental.payment.nextDueDate)}</p>
//                         </div>
//                       )}
//                     </div>
...
//                       </div>
//                       <div>
//                         <p className="font-medium">{rental.address.contactDetails.name}</p>
//                         <p className="text-sm text-gray-600">{rental.address.addressLine1}</p>
//                         {rental.address.addressLine2 && <p className="text-sm text-gray-600">{rental.address.addressLine2}</p>}
//                         <p className="text-sm text-gray-600">
//                           {rental.address.city}, {rental.address.state} - {rental.address.pincode}
//                         </p>
//                         <p className="text-sm text-gray-600 mt-1">📞 {rental.address.contactDetails.phone}</p>
//                       </div>
//                     </div>
//                   </CardContent>
//                 </Card>
...
//                       <div className="space-y-2">
//                         <div className="flex justify-between text-sm">
//                           <span className="text-gray-600">Subtotal ({rental.rentalDetails.tenureMonths} months)</span>
//                           <span>{formatCurrency(rental.rentalDetails.subtotal)}</span>
//                         </div>
//                         <div className="flex justify-between text-sm">
//                           <span className="text-gray-600">Security Deposit</span>
//                           <span>{formatCurrency(rental.rentalDetails.securityDeposit)}</span>
//                         </div>
//                         <div className="flex justify-between text-sm">
//                           <span className="text-gray-600">Delivery Charges</span>
//                           <span>{formatCurrency(rental.rentalDetails.deliveryCharges)}</span>
//                         </div>
//                         <div className="flex justify-between text-sm">
//                           <span className="text-gray-600">GST (18%)</span>
//                           <span>{formatCurrency(rental.rentalDetails.tax)}</span>
//                         </div>
//                         <Separator />
...
//                 </div>
//                 <h3 className="font-semibold text-gray-900 mb-1">{statusConfig.label}</h3>
...
//                   <span className="font-medium">{formatCurrency(rental.rentalDetails.monthlyRent)}</span>
//                 </div>
//                 <div className="flex justify-between">
//                   <span className="text-gray-600">Security Deposit</span>
//                   <span className="font-medium">{formatCurrency(rental.rentalDetails.securityDeposit)}</span>
//                 </div>
//                 <div className="flex justify-between">
//                   <span className="text-gray-600">Total Paid</span>
//                   <span className="font-medium text-green-600">{formatCurrency(rental.payment.paidAmount)}</span>
//                 </div>
//                 {rental.payment.dueAmount > 0 && (
//                   <div className="flex justify-between">
//                     <span className="text-gray-600">Due Now</span>
//                     <span className="font-medium text-red-600">{formatCurrency(rental.payment.dueAmount)}</span>
//                   </div>
//                 )}
//               </CardContent>
//               {rental.payment.dueAmount > 0 && (
...
//                   <Button 
//                     variant="outline" 
//                     className="w-full justify-start gap-3 border-red-200 hover:bg-red-50"
...
//                   <span className="font-mono">{rental.inventory[0]?.sku || '—'}</span>
//                 </div>
//                 <div className="flex justify-between">
//                   <span className="text-gray-600">Inventory Status</span>
//                   <Badge variant="outline" className="text-xs">
//                     {rental.inventory[0]?.status || 'Unknown'}
//                   </Badge>
//                 </div>
//                 <div className="flex justify-between">
//                   <span className="text-gray-600">Condition</span>
//                   <span className="capitalize">{rental.inventory[0]?.condition?.status || 'Good'}</span>
//                 </div>
//               </CardContent>
//             </Card>
//           </div>
...
//               <p className="text-xl font-bold text-indigo-600">{formatCurrency(extensionCost)}</p>
//               <p className="text-xs text-gray-500 mt-1">Will be charged upon approval</p>
//             </div>
//           </div>
//           <DialogFooter>
...
//             <DialogDescription>
//               Get help with your rental from our support team.
//             </DialogDescription>
//           </DialogHeader>
//           <div className="py-4 space-y-4">
...
//                 <p className="text-sm text-gray-600">support@rentease.com</p>
//               </div>
//             </div>
//             <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
...
//                 <p className="text-xs text-gray-400">Mon-Sat, 10 AM - 7 PM</p>
//               </div>
//             </div>
//             <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
...
//         <DialogContent>
//           <DialogHeader>
//             <DialogTitle>Report Issue / Damage</DialogTitle>
//             <DialogDescription>
...
//               />
//               <p className="text-xs text-gray-500 mt-1">Upload clear photos of the damage</p>
//             </div>
//           </div>
//           <DialogFooter>
