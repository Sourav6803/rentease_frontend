...
export function InterestEmptyState({
  title = 'No customer interests detected yet',
  description = 'Behavioral signals will appear here once customers interact with products across the storefront.',
  actionLabel,
  onAction,
  className,
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative mb-6 flex h-24 w-24 items-center justify-center rounded-3xl bg-gradient-to-br from-indigo-500 to-blue-500 shadow-lg"
      >
...
export default InterestEmptyState
